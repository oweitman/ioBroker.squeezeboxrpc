...
class ioUtil {
     ...
     * prefixes:
     * fs_  sbFavoritesState
     * ss_  sbServerStatus
     * psm_ sbPlayerStatusMain
     * psl_ sbPlayerStatusLoop
     * pb_  sbPlayerButtons
     * psp_ sbPlayerStatusPlaylist
     *
    ...
    addTranslations(i18n, obj, prefix) {
        for (const key in obj) {
            let tranlateObj = i18n.getTranslatedObject(`${prefix}_${key}`);
            obj[key].desc = tranlateObj;
        }
    }
}
/**
