...
class DateTimeWidget extends PlayerStateWidget {
    static getWidgetInfo() {
        return {
            id: 'tplSqueezeboxrpcDateTime2', visSet: 'vis2squeezeboxrpc', visSetLabel: 'widget_set',
    ...
    getWidgetInfo() { return DateTimeWidget.getWidgetInfo(); }

    renderWidgetBody(props) {
        super.renderWidgetBody(props);
        const data = this.widgetState.rxData || this.widgetState.data || {};
        const value = this.widgetState.playerValue === undefined ? '' : formatDateTime(this.widgetState.playerValue, data.factor, data.format);
