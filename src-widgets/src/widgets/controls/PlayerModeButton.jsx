...
class PlayerModeButton extends WidgetBase {
    ...
    renderWidgetBody(props) {
        ...
        const repeat0Fallback = this.modeConfig.mode === 'repeat' && state === 2
            ? data[`${this.modeConfig.imagePrefix}0`]
            : '';
