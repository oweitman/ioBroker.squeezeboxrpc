...
`;
  ...
  // squeezeboxrpc/img/add.svg
  var add_default = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><g fill="currentColor" stroke="currentColor" stroke-width=".3"><path d="M14 10H3v2h11zm0-4H3v2h11zm4 8v-4h-2v4h-4v2h4v4h2v-4h4v-2zM3 16h7v-2H3z"/></g></svg>\n';

  // squeezeboxrpc/img/delete.svg
  var delete_default = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM8 9h8v10H8V9zm7.5-5-1-1h-5l-1 1H5v2h14V4z"/></svg>\n';

  // squeezeboxrpc/img/fwd.svg
  var fwd_default = '<svg viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg" fill="currentColor">\n  <g transform="matrix(.56122 0 0 .56122 28.082 28.081)">\n    <path d="m98 24h15v80h-15z"/>\n    <path transform="matrix(1.0892 0 0 1.1187 -4.5514 -7.5937)" d="m58.834 29.054 46.333 29.892a6.0144 6.0144 90 0 1 0 10.108l-46.333 29.892a5.0797 5.0797 28.586 0 1-7.8335-4.2684v-61.355a5.0797 5.0797 151.41 0 1 7.8335-4.2684z"/>\n    <path transform="matrix(1.0892 0 0 1.1187 -40.551 -7.5937)" d="m58.834 29.054 46.333 29.892a6.0144 6.0144 90 0 1 0 10.108l-46.333 29.892a5.0797 5.0797 28.586 0 1-7.8335-4.2684v-61.355a5.0797 5.0797 151.41 0 1 7.8335-4.2684z"/>\n  </g>\n</svg>';

  // squeezeboxrpc/img/menuback.svg
  var menuback_default = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><g fill="currentColor" stroke="currentColor" stroke-width=".3"><path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20z"/></g></svg>\n';

  // squeezeboxrpc/img/next.svg
  var next_default = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><g fill="currentColor" stroke="currentColor" stroke-width=".3"><path d="m12 4-1.41 1.41L16.17 11H4v2h12.17l-5.58 5.59L12 20l8-8z"/></g></svg>\n';

  // squeezeboxrpc/img/pause.svg
  var pause_default = '<svg\n  xmlns="http://www.w3.org/2000/svg"\n  viewBox="0 0 128 128"\n  fill="currentColor"\n>\n  <g transform="matrix(2.8247 0 0 2.8247 26.631 26.631)">\n    <rect x="5.396" y="5.396" width="6.4058" height="15.666" ry=".28773"/>\n    <rect x="14.656" y="5.396" width="6.4058" height="15.666" ry=".28773"/>\n  </g>\n</svg>';

  // squeezeboxrpc/img/play.svg
  var play_default = '<svg\n  xmlns="http://www.w3.org/2000/svg"\n  viewBox="0 0 128 128"\n  fill="currentColor"\n>\n  <path d="m44.069 33.703 44.77 25.915a5.8115 5.2143 0 0 1 0 8.7633l-44.77 25.915a4.9083 4.4039 0 0 1-7.5692-3.7006v-53.192a4.9083 4.4039 0 0 1 7.5692-3.7006z"/>\n</svg>\n';

  // squeezeboxrpc/img/repeat0.svg
  var repeat0_default = '<svg viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">\n  <g transform="matrix(3.5107 0 0 3.5106 17.557 20.769)" fill="currentColor">\n    <path transform="scale(.26458)" d="m35.473 20.621c-8.2281 0-14.852 6.6235-14.852 14.852v29.055c0 8.2281 6.6235 14.852 14.852 14.852h29.055c8.2281 0 14.852-6.6235 14.852-14.852v-29.055c0-8.2281-6.6235-14.852-14.852-14.852h-4.0195v9.6641c0 .05754-.01898.1113-.02344.16797 5.108.40503 9.1016 4.6456 9.1016 9.8613v19.371c0 5.4854-4.415 9.9004-9.9004 9.9004h-19.371c-5.4854 0-9.9004-4.415-9.9004-9.9004v-19.371c0-5.4854 4.415-9.9004 9.9004-9.9004h.21094c-.0026-.04363-.01758-.08477-.01758-.12891v-9.6641z"/>\n    <path d="m10.111 9.4128v-5.3598c-.0082.018122-.0021-.17387.24672-.34879.24874-.17491.65793 0 .65793 0l4.6078 2.7541s.1702.098349.16971.29612c-.000497.20056-.1784.32361-.1784.32361l-4.5991 2.7487s-.39816.13052-.65793-.063572c-.25976-.19409-.24672-.35035-.24672-.35035z"/>\n  </g>\n</svg>';

  // squeezeboxrpc/img/repeat1.svg
  var repeat1_default = '<svg viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">\n  <g transform="matrix(1.0443 0 0 1.0443 -1.6877 -1.4835)" fill="currentColor">\n    <path d="m49.974 39.646c-7.3148 0-13.204 5.8883-13.204 13.204v25.83c0 7.3148 5.8883 13.204 13.204 13.204h13.599c-.08826-.20751-.18232-.41241-.25351-.63029-.91692-2.8066-.32741-5.663 1.2259-8.0757h-10.267c-4.8766 0-8.8015-3.925-8.8015-8.8015v-17.221c0-4.8765 3.925-8.8015 8.8015-8.8015h.18753c-.0023-.03878-.01563-.07535-.01563-.1146v-8.5915zm22.256 0v8.5915c0 .05114-.0168.09896-.02084.14933 1.4494.11493 2.7963.58042 3.9606 1.3075v-4.2159h9.043l-.158 2.6705v.0069c.0015.72589.46222 1.7794 1.5106 3.1897.6702.90145 1.5365 1.9099 2.4413 3.0177v-1.5141c0-7.3148-5.8883-13.204-13.204-13.204zm12.825 25.264-.0069 20.56c.01981 1.0467-.14027 2.0683-.44277 3.0473 2.6983-2.4141 4.4017-5.9157 4.4017-9.8378v-3.6897c-.50056.10026-1.0682.08993-1.6687-.16321-1.3963-.58871-1.712-1.7874-1.7971-2.4604-.08511-.67302.0027-1.1974.16321-1.7259.07429-.24506.28242-3.0184-.34032-5.0927-.07819-.26036-.22043-.40039-.30907-.63724z"/>\n    <path d="m52.414 52.942v-18.009c-.02755.06088-.0071-.58422.829-1.172.83578-.58771 2.2107 0 2.2107 0l15.483 9.254s.57188.33046.57024.99498c-.0017.6739-.59944 1.0874-.59944 1.0874l-15.453 9.2358s-1.3378.43856-2.2107-.2136c-.87281-.65216-.829-1.1772-.829-1.1772z"/>\n    <path d="m82.375 48.148h-3.5496v32.228c-1.9626-.84136-4.5025-.85305-7.0078.16182-4.4884 1.82-7.1623 6.247-5.9735 9.8867 1.1895 3.6406 5.7921 5.1154 10.28 3.2955 3.812-1.5454 6.3058-4.9716 6.2447-8.1982l.006-26.357c6.1892 1.0868 6.613 9.805 5.8717 12.25-.28151.92651.2142 1.6203 1.1497 0 6.6738-11.567-7.0212-16.671-7.0212-23.266z"/>\n  </g>\n</svg>';

  // squeezeboxrpc/img/refresh.svg
  var refresh_default = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M17.65 6.35A7.96 7.96 0 0 0 12 4a8 8 0 1 0 7.73 10h-2.08A6 6 0 1 1 16.22 7.78L13 11h7V4z"/></svg>\n';

  // squeezeboxrpc/img/rew.svg
  var rew_default = '<svg viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg" fill="currentColor">\n  <g transform="matrix(.56121 0 0 .56122 28.082 28.082)">\n    <path d="m30 24h-15v80h15z"/>\n    <path d="m68.467 24.908-50.468 33.439a6.5512 6.728 0 0 0 0 11.307l50.468 33.439a5.533 5.6824 0 0 0 8.5326-4.7749v-68.635a5.533 5.6824 0 0 0-8.5326-4.7749z"/>\n    <path d="m104.47 24.907-50.468 33.439a6.5512 6.728 0 0 0 0 11.307l50.468 33.439a5.533 5.6824 0 0 0 8.5326-4.7749v-68.635a5.533 5.6824 0 0 0-8.5326-4.7749z"/>\n  </g>\n</svg>';

  // squeezeboxrpc/img/shuffle0.svg
  var shuffle0_default = '<svg\n  xmlns="http://www.w3.org/2000/svg"\n  viewBox="0 0 128 128"\n  fill="currentColor"\n>\n  <g transform="translate(-1 -1.5)">\n    <rect x="35" y="35" width="40" height="10"/>\n    <rect x="55" y="52" width="40" height="10"/>\n    <rect x="35" y="69" width="40" height="10"/>\n    <rect x="55" y="86" width="40" height="10"/>\n  </g>\n</svg>';

  // squeezeboxrpc/img/shuffle2.svg
  var shuffle2_default = '<svg\n  xmlns="http://www.w3.org/2000/svg"\n  viewBox="0 0 128 128"\n  fill="currentColor"\n>\n  <path d="m34 33.5v10h40v-10h-40zm20 17v10h40v-10h-40zm-20 17v10h34.5v-3.543c0-2.1921 1.7649-3.957 3.957-3.957h1.543v-2.5h-40zm20 17v10h18.457c-2.1921 0-3.957-1.7649-3.957-3.957v-6.043h-14.5z"/>\n\n  <rect\n    x="72.5"\n    y="73"\n    width="20"\n    height="20"\n    rx="3"\n    fill="none"\n    stroke="currentColor"\n    stroke-width="3"\n  />\n</svg>';

  // squeezeboxrpc/img/stop.svg
  var stop_default = '<?xml version="1.0" encoding="UTF-8"?>\n<svg\n  version="1.1"\n  xmlns="http://www.w3.org/2000/svg"\n  viewBox="0 0 128 128"\n  fill="currentColor"\n>\n  <path\n    d="M0 0 C15.18 0 30.36 0 46 0 C46 15.18 46 30.36 46 46 C30.82 46 15.64 46 0 46 C0 30.82 0 15.64 0 0 Z"\n    transform="translate(41,41)"\n  />\n</svg>';

  // squeezeboxrpc/js/svgIcons.js
  var inlineSvg = (source) => source.replace(/^\s*<\?xml[^>]*>\s*/i, "").trim();
  var svgIcons = {
    add: inlineSvg(add_default),
    delete: inlineSvg(delete_default),
    fwd: inlineSvg(fwd_default),
    menuback: inlineSvg(menuback_default),
    next: inlineSvg(next_default),
    pause: inlineSvg(pause_default),
    play: inlineSvg(play_default),
    repeat0: inlineSvg(repeat0_default),
    repeat1: inlineSvg(repeat1_default),
    refresh: inlineSvg(refresh_default),
    rew: inlineSvg(rew_default),
    shuffle0: inlineSvg(shuffle0_default),
    shuffle2: inlineSvg(shuffle2_default),
    stop: inlineSvg(stop_default)
  };
